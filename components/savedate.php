<div class="relative h-[73rem] my-10 w-full ">
    ...
    <img src="../public/img/pasir-daun-bawah.webp" alt="" class="right-0 left-0  -bottom-[3rem] w-full absolute z-10 ">
    ...
    <div class="absolute flex left-0 right-0 top-32 justify-center  ">
        <div class="  font-poppins backdrop-blur-sm text-paragraph z-[9] border-4 dark:text-d-text dark:bg-d-container border-golden pt-10 pb-16  bg-white/30 text-center px-3">
            ...
            <div class="px-10 bg-slate-800/70 hidden  backdrop-blur-lg z-50 absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center flex-col" id="alamat">
                ...
                <a href="https://maps.app.goo.gl/3zJC6GxGygu8hGGY9" target="_blank" class=" mt-5 mx-auto mb-4 text-white bg-timeline flex items-center justify-center rounded-lg gap-2 px-5 py-2 text-sm" onclick="lihatLokasi()">
